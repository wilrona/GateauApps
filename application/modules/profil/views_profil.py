...
@prefix.route('/profil/edit/<int:profil_id>',  methods=['GET', 'POST'])
@login_required
@roles_required([('super_admin', 'profil')], ['edit'])
...
@prefix.route('/profil/delete/<int:profil_id>')
@login_required
@roles_required([('super_admin', 'profil')], ['delete'])
...
@prefix.route('/profil/role/<int:profil_id>',  methods=['GET', 'POST'])
def list(profil_id):
    ...
    if request.method == 'POST':
        ...
        if view_succes:
            ...
            flash('Impossible de vider ce profil en role car il est utilise par un utilisateur', 'warning')
